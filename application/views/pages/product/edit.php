<div class="container">
	...
	<div class="row bg-light p-3 mt-4">
		<div class="col">
			...
			<?php echo form_open_multipart(base_url('product/edit/' . $product['id'])) ?>
					...
					<div class="col-5">
						<div class="form-group">
							...
							<select class="form-control" name="edition">
								<option value="Liquid" <?php if($product['edition'] == "Liquid"){ echo ' selected'; }?>>Liquid</option>
								<option value="Mod" <?php if($product['edition'] == "Mod"){ echo ' selected'; }?>>Mod</option>
								<option value="Pod" <?php if($product['edition'] == "Pod"){ echo ' selected'; }?>>Pod</option>
								<option value="Rda" <?php if($product['edition'] == "Rda"){ echo ' selected'; }?>>Rda</option>
								<option value="Cotton" <?php if($product['edition'] == "Cotton"){ echo ' selected'; }?>>Cotton</option>
							</select>
						</div>
					</div>
				</div>
